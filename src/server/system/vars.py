...
class Vars(Enum):
    _MAIN_PATH = Path(__file__).parents[3] # ensures we are working in the main directory
    ...
    PKG_PATH = f"{_MAIN_PATH}/dist/{_PKG_DIR_NAME}"
    SERVER_PATH = f"{_MAIN_PATH}/src/{_SERVER_DIR_NAME}"
    ZIP_PATH = f"{_MAIN_PATH}/dist"
